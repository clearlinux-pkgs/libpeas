...
Source0  : https://download.gnome.org/sources/libpeas/1.30/libpeas-1.30.0.tar.xz
...
%prep
%setup -q -n libpeas-1.30.0
cd %{_builddir}/libpeas-1.30.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636126027
...
cp %{_builddir}/libpeas-1.30.0/COPYING %{buildroot}/usr/share/package-licenses/libpeas/3704f4680301a60004b20f94e0b5b8c7ff1484a9
