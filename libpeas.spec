...
Source0  : https://download.gnome.org/sources/libpeas/1.26/libpeas-1.26.0.tar.xz
...
%prep
%setup -q -n libpeas-1.26.0
cd %{_builddir}/libpeas-1.26.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585785173
...
cp %{_builddir}/libpeas-1.26.0/COPYING %{buildroot}/usr/share/package-licenses/libpeas/3704f4680301a60004b20f94e0b5b8c7ff1484a9
