...
Source0  : https://download.gnome.org/sources/libpeas/1.21/libpeas-1.21.0.tar.xz
Summary  : libpeas, a GObject plugins library
...
export LANG=C
export SOURCE_DATE_EPOCH=1502197811
...
/usr/lib64/libpeas-1.0.so.0.2100.0
/usr/lib64/libpeas-gtk-1.0.so.0
/usr/lib64/libpeas-gtk-1.0.so.0.2100.0
