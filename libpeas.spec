...
Source0  : https://download.gnome.org/sources/libpeas/2.0/libpeas-2.0.1.tar.xz
...
%prep
%setup -q -n libpeas-2.0.1
cd %{_builddir}/libpeas-2.0.1
pushd ..
cp -a libpeas-2.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705535929
